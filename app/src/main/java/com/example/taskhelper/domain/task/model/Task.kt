package com.example.taskhelper.domain.task.model
...
data class Task(
    ...
    val completed: Boolean, // Estado de completado que la UI mostrará (checkbox, estilo tachado, etc.).
    val createdAt: Instant? = null // Fecha de creación
)
